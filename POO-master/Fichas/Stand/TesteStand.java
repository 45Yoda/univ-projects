...
public class TesteStand {
  ...
  public static void main(String[] args) {
    ...
    v1 = new Veiculo("01-01-AA",1000,100,10,1000,900);
    v2 = new Veiculo("05-05-ZZ",1000,100,10,1000,900);
    /**v3 = new Veiculo(...);
    v4 = ...;
    v5 = ...;
    ...
    d5 = ...;
    */
    veiculos_utilitarios = new Stand("Garagem Veiculos Baratos\n", 10);
    ...
    */
    ...
    System.out.println("Informações do Stand \n" + veiculos_utilitarios.getNomeStand());
    System.out.println("--------------------------");
    System.out.println("Número de veículos: \n" + veiculos_utilitarios.getNVeiculos());
    ...
    */
    ...
    //o v2 está no stand?
    System.out.println("v2 está no stand? "+ veiculos_utilitarios.existeVeiculoPorMatricula("05-05-ZZ"));
